...
export class TestData {
  ...
  static priorities: Priority[] = [
    {id: 1, title: 'Низкий', color: '#e5e5e5', urgency: "Low"},
    {id: 2, title: 'Средний', color: '#85D1B2', urgency: "Medium"},
    {id: 3, title: 'Высокий', color: '#F1828D', urgency: "High"},
    {id: 4, title: 'Cрочно!', color: '#F1128D', urgency: "ExtraHigh"}
  ];
